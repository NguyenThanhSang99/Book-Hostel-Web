...
/**
 * Servlet Filter implementation class AdminPermissionFilter
 */
@WebFilter({"/adminPage","/deleteUser","/userList","/hostList","/listRequestHost"})
public class AdminPermissionFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(session != null && session.getAttribute("role")!= null) {
			...
			} else if (session != null && session.getAttribute("role")!= null && session.getAttribute("role").equals("host")){
				RequestDispatcher dispatcher = httpReq.getServletContext().getRequestDispatcher("/WEB-INF/views/hostPage.jsp");
